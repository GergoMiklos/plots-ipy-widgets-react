...
# -*- coding: utf-8 -*-
#
# plots_ipy_widgets_react documentation build configuration file
#
...
project = 'plots_ipy_widgets_react'
...
_version_py = os.path.join(repo, 'plots_ipy_widgets_react', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'plots_ipy_widgets_reactdoc'
...
latex_documents = [
    (master_doc, 'plots_ipy_widgets_react.tex', 'plots_ipy_widgets_react Documentation',
     'Gergo Miklos', 'manual'),
]
...
man_pages = [
    (master_doc,
    'plots_ipy_widgets_react',
    'plots_ipy_widgets_react Documentation',
     [author], 1)
]
